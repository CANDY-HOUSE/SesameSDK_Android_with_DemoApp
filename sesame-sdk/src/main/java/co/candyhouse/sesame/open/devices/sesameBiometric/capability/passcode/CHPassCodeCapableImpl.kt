...
internal open class CHPassCodeCapableImpl() :
    ...
    override fun registerEventDelegate(device: CHCapabilityHost, delegate: CHPassCodeDelegate) {
        setupSupport(device)
    ...
    override fun unregisterEventDelegate(device: CHCapabilityHost, delegate: CHPassCodeDelegate) {
