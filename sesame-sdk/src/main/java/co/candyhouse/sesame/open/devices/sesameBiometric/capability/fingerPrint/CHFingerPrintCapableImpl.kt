...
internal class CHFingerPrintCapableImpl() :
    ...
    override fun registerEventDelegate(device: CHCapabilityHost, delegate: CHFingerPrintDelegate) {
        setupSupport(device)
    ...
    override fun unregisterEventDelegate(device: CHCapabilityHost, delegate: CHFingerPrintDelegate) {
