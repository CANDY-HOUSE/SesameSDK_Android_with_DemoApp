...
interface CHPassCodeDelegate {
    fun onKeyBoardReceive(device: CHSesameConnector, ID: String, hexName: String, type: Byte) {}
    fun onKeyBoardChanged(device: CHSesameConnector, ID: String, hexName: String, type: Byte) {}
