...
internal open class CHCardCapableImpl() :
    ...
    override fun registerEventDelegate(device: CHCapabilityHost, delegate: CHCardDelegate) {
        setupSupport(device)
    ...
    override fun unregisterEventDelegate(device: CHCapabilityHost, delegate: CHCardDelegate) {
