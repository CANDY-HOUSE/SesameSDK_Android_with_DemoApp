...
internal class CHFaceCapableImpl() :
    ...
    override fun registerEventDelegate(device: CHCapabilityHost, delegate: CHFaceDelegate) {
        setupSupport(device)
    ...
    override fun unregisterEventDelegate(device: CHCapabilityHost, delegate: CHFaceDelegate) {
