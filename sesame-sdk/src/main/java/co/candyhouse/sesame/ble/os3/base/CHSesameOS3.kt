    ...
    private val mBluetoothGattCallback: BluetoothGattCallback = object : BluetoothGattCallback() {
        ...
        override fun onMtuChanged(gatt: BluetoothGatt?, mtu: Int, status: Int) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                if ((productModel == CHProductModel.SSMTouchPro) || (productModel == CHProductModel.SSMTouchPro2) || (productModel == CHProductModel.SSMTouch) || (productModel == CHProductModel.SSMTouch2) || (productModel == CHProductModel.SSMFacePro) || (productModel == CHProductModel.SSMFacePro2) || (productModel == CHProductModel.SSMFaceProAI) || (productModel == CHProductModel.SSMFaceAI) || (productModel == CHProductModel.SSMFace) || (productModel == CHProductModel.SSMFace2)) {
        ...
        override fun onConnectionStateChange(gatt: BluetoothGatt, status: Int, newState: Int) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                if ((productModel == CHProductModel.SSMTouchPro) || (productModel == CHProductModel.SSMTouchPro2) || (productModel == CHProductModel.SSMTouch) || (productModel == CHProductModel.SSMTouch2) || (productModel == CHProductModel.SSMFacePro) || (productModel == CHProductModel.SSMFacePro2) || (productModel == CHProductModel.SSMFaceAI) || (productModel == CHProductModel.SSMFaceProAI) || (productModel == CHProductModel.SSMFace) || (productModel == CHProductModel.SSMFace2)) { // 连接成功后立即请求MTU变更
