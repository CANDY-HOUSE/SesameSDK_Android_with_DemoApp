...
object ItemUtils {
    ...
    fun getCustomSamples(context: Context): List<BarMenuItem> {
        ...
        samples.add(
            BarMenuItem(
                1,
                drawable(context, R.drawable.ic_cube_2),
                context.getString(R.string.new_sesame)
            )
        )
        samples.add(
            BarMenuItem(
                2,
                drawable(context, R.drawable.ic_qr_code_scan_2),
                context.getString(R.string.scan_the_qr_code)
            )
        )
        samples.add(
            BarMenuItem(
                3,
                drawable(context, R.drawable.find_friend),
