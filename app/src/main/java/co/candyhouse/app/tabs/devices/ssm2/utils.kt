...
fun CHDevices.getFirmwareName(): String? {
    ...
    return when (productModel) {
        ...
        CHProductModel.SSMTouchPro -> "sesametouch1pro_30_9_846ade"
        CHProductModel.SSMTouch -> "sesametouch1_30_10_846ade"
        ...
        CHProductModel.SS6Pro -> "sesame6pro_30_21_10b4d9"
        CHProductModel.SSMOpenSensor2 -> "opensensor2_30_24_2f5b11"
        else -> null
    }
}
