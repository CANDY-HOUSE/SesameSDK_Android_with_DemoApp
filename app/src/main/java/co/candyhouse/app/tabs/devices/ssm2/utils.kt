...
fun CHDevices.getFirmwareName(): String? {
    ...
    return when (productModel) {
        ...
        CHProductModel.SSMOpenSensor2 -> "opensensor2_30_24_4607a9"
        ...
        CHProductModel.SSMFaceAI -> "sesameface1ai_30_23_43ca70"
        else -> null
    }
}
...
fun CHProductModel.modelName(): String {
    return when (this) {
        ...
        CHProductModel.SSMTouchPro2 -> CHDeviceManager.app.getString(R.string.SSMTouchPro2)
        ...
        CHProductModel.SSMFacePro2 -> CHDeviceManager.app.getString(R.string.SSMFacePro2)
    }
}
