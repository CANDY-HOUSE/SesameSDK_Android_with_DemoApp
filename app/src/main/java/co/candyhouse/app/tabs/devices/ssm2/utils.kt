...
fun CHDevices.getFirZip(): Int {
    ...
    return when (productModel) {
        ...
        CHProductModel.SS6 -> R.raw.sesame6_30_20_223c1d
        ...
        CHProductModel.SS6Pro -> R.raw.sesame6pro_30_21_b20922
        else ->0
    }
...
fun CHProductModel.modelName(): String {
    return when (this) {
        ...
        CHProductModel.SS6 -> MainActivity.activity!!.getString(R.string.Sesame6)
