...
class ScanQRcodeFG : BaseFG<ActivitySimpleScannerBinding>(), QRCodeView.Delegate,
    ...
    private fun CHProductModel?.isValidModel(): Boolean {
        return this == CHProductModel.SS5 || this == CHProductModel.BiKeLock2 || this == CHProductModel.SSMTouchPro || this == CHProductModel.SSMTouchPro2 ||
                ...
                this == CHProductModel.SSMFacePro || this == CHProductModel.SSMFacePro2 || this == CHProductModel.SSMFaceProAI || this == CHProductModel.SSMFaceAI || this == CHProductModel.SS6Pro ||
