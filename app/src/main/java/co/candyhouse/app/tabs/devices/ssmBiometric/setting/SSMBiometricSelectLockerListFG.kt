        ...
        bind.leaderboardList.apply {
            val filteredDevices =
                when ((mDeviceModel.ssmLockLiveData.value as CHSesameConnector).productModel) {
                    ...
                    CHProductModel.Hub3 -> mDeviceModel.myChDevices.value.filter { it.productModel == CHProductModel.SSMTouchPro || it.productModel == CHProductModel.SS5PRO || it.productModel == CHProductModel.SS6 || it.productModel == CHProductModel.SS5 }
