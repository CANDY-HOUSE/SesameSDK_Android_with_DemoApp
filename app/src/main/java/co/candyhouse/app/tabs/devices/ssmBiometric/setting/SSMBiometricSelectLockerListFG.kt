        ...
        bind.leaderboardList.apply {
            val filteredDevices =
                when ((mDeviceModel.ssmLockLiveData.value as CHSesameConnector).productModel) {
                    ...
                    CHProductModel.Hub3 -> mDeviceModel.myChDevices.value.filter { it.productModel == CHProductModel.SSMTouchPro || it.productModel == CHProductModel.SS5PRO || it.productModel == CHProductModel.SS5 || it.productModel == CHProductModel.SSMTouchPro2 }
                    ...
                    CHProductModel.SSMFacePro,CHProductModel.SSMFacePro2 -> mDeviceModel.myChDevices.value.filter { (it is CHSesameLock) && it.productModel != CHProductModel.SS2 && it.productModel != CHProductModel.SS4 && it.productModel != CHProductModel.BiKeLock && it.productModel != CHProductModel.SesameBot1 }
