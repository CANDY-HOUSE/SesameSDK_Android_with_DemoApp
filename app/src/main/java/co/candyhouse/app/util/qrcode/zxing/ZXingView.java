package co.candyhouse.app.util.qrcode.zxing;
...
import co.candyhouse.app.util.qrcode.core.BGScanResult;
import co.candyhouse.app.util.qrcode.core.BarcodeType;
