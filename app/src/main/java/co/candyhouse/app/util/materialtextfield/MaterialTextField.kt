package co.candyhouse.app.util.materialtextfield
...
import co.candyhouse.app.util.materialtextfield.custom.AnimatedRectF
import co.candyhouse.app.util.materialtextfield.custom.WrapDrawable
import kotlin.math.max
import kotlin.math.roundToInt

open class MaterialTextField : androidx.appcompat.widget.AppCompatEditText {
    ...
    private var rightIcon: Drawable? = null
        set(value) {
            ...
            val rightButtonIcon = when {
                ...
                else -> ContextCompat.getDrawable(context, R.drawable.ic_icon_delete)
            }
            rightButtonIcon?.let {
